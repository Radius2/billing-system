...
export const str = {
    [ACCESSORS.ACT]: {
        ...
        ...setSubPath(() => acts.structureTable, 'actnumber'),
        ...setValidation(),
    },
    ...
    [ACCESSORS.PU]: {
        ...setHeader('Прибор учета'),
        ...setAccessor(ACCESSORS.PU, 200),
        ...setType(TYPE.SUB_VALUE, true),
        ...setOrdering(true, true),
        ...setSubPath(() => pu.structureTable, 'id'),
        ...setValidation(),
    },
    [ACCESSORS.PU_NUMBER]: {
        ...setHeader('Номер прибора учета'),
...
export const structureTable = {
    ...
    oneElementComponent: ActDetailsFormOneElement,
    maxWidth: '900px',
    noDeleteButton: true,
    formName: FORM_NAME,
    columns: [
